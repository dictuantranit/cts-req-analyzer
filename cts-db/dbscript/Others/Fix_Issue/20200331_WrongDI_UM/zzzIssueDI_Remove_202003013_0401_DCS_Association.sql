...
DROP PROCEDURE IF EXISTS DCS_DataCenter.zzzIssueDI_Association_Remove_UM$$

CREATE PROCEDURE DCS_DataCenter.zzzIssueDI_Association_Remove_UM()
BEGIN
	/*
   ...
   WHILE EXISTS (SELECT AssociationID
        ...
        WHERE 	ad.CreatedTime >= '2020-04-01' AND ad.CreatedTime <= '2020-04-01 5:00:00' AND AssociationID > vr_AssociationID)  
   DO
        ...
        INSERT IGNORE INTO DCS_DataCenter.zzzIssueDI_Association_UM
		SELECT 		ad.*
