...
WHERE	ad.CreatedDate >= '2020-04-01' AND ad.CreatedTime <= '2020-04-01 5:00:00';
   ...
   WHILE EXISTS (SELECT DeviceCodeID
        FROM 	DCS_DataCenter.DeviceCode ad
        WHERE 	ad.CreatedDate >= '2020-04-01' AND ad.CreatedTime <= '2020-04-01 5:00:00' AND DeviceCodeID > vr_DeviceCodeID)  
   DO		
        ...
        INSERT IGNORE INTO DCS_DataCenter.zzzIssueDI_DeviceCode_UM
		SELECT 		ad.*
