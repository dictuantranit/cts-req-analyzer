CREATE TABLE IF NOT EXISTS CTS_DataCenter.zzzIssueDI_AssociationByDevice(
...
CREATE TABLE IF NOT EXISTS DCS_DataCenter.zzzIssueDI_Association(
...
CREATE TABLE IF NOT EXISTS DCS_DataCenter.zzzIssueDI_Device(		
   	...
   	CREATE TABLE IF NOT EXISTS DCS_DataCenter.zzzIssueDI_DeviceCode(
	...
	CREATE TABLE IF NOT EXISTS DCS_DataCenter.zzzIssueDI_DeviceFingerprint(
...
CREATE TABLE DCS_DataCenter.zzzIssueDI_Transaction (
  LastTransID BIGINT UNSIGNED
) ENGINE=InnoDB;

INSERT INTO DCS_DataCenter.zzzIssueDI_Transaction
(LastTransID)
VALUES (0);

     
CREATE TABLE DCS_DataCenter.zzzIssueDI_Transaction07 (
  LastTransID BIGINT UNSIGNED
) ENGINE=InnoDB;

INSERT INTO DCS_DataCenter.zzzIssueDI_Transaction07
(LastTransID)
VALUES (0);


CREATE TABLE DCS_DataCenter.zzzIssueDI_Transaction_BK01 (
  LastTransID BIGINT UNSIGNED
) ENGINE=InnoDB;

INSERT INTO DCS_DataCenter.zzzIssueDI_Transaction_BK01
(LastTransID)
VALUES (0);
