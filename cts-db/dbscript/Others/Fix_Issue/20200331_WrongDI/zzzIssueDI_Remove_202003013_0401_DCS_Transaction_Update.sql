...
BEGIN
   ...
   WHILE EXISTS (SELECT 1 FROM DCS_DataCenter.Transaction WHERE TransID > vr_LastTransID AND CreatedDate >= '2020-03-27' AND TransTime <= '2020-04-01 00:00:00' AND DeviceID > 0)  
   DO
