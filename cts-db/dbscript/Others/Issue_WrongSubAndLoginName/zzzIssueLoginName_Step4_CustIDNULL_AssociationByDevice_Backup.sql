...
DROP PROCEDURE IF EXISTS CTS_DataCenter.zzzIssueLoginName_Step4_CustIDNULL_AssociationByDevice_Backup$$

CREATE PROCEDURE CTS_DataCenter.zzzIssueLoginName_Step4_CustIDNULL_AssociationByDevice_Backup()
BEGIN
	/*
   ...
   DO
        ...
        INSERT INTO CTS_DataCenter.zzzIssueLoginName_AssociationByDevice
        SELECT 	ct.*
