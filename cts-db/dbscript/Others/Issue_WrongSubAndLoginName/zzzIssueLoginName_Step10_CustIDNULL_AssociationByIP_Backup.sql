...
DROP PROCEDURE IF EXISTS CTS_DataCenter.zzzIssueLoginName_Step10_CustIDNULL_AssociationByIP_Backup$$

CREATE PROCEDURE CTS_DataCenter.zzzIssueLoginName_Step10_CustIDNULL_AssociationByIP_Backup()
BEGIN
	/*
	...
	*/
    ...
    #INNER JOIN 	CTS_DataCenter.AssociationByIP AS ct
   ...
   DO
		...
		INSERT INTO CTS_DataCenter.zzzIssueLoginName_AssociationByIP
        SELECT 		ct.*
