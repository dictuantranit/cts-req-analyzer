...
DROP PROCEDURE IF EXISTS CTS_DataCenter.zzzIssueLoginName_Step3_CustIDNULL_CTSCustomer_Remove$$

CREATE PROCEDURE CTS_DataCenter.zzzIssueLoginName_Step3_CustIDNULL_CTSCustomer_Remove()
BEGIN
	/*
	...
	*/
    ...
    INNER JOIN 	CTS_DataCenter.CTSCustomer AS ct
