...
DROP PROCEDURE IF EXISTS CTS_DataCenter.zzzIssueLoginName_Step8_CustIDNULL_CustEvidence_Backup$$

CREATE PROCEDURE CTS_DataCenter.zzzIssueLoginName_Step8_CustIDNULL_CustEvidence_Backup()
BEGIN
	/*
