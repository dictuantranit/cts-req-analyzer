...
delete from MatchMonitorStagingLive where matchid = 22081995;
#==Precondition Data ==========================
...
SELECT * FROM CTS_DataCenter.MatchMonitorStagingLive where matchid = 22081995;
...
CALL CTS_DC_MatchMonitor_Rule_Complete(1,111880559252,22081995,1,1,'[{"GroupID":1,"IsHedging":1,"TransIDList":"111880559250,111880559251,111880559252","CustIDList":"37144067,37144068,37144070","OldGroupIDList":"0,1"}]');
...
SELECT  * FROM CTS_DataCenter.Temp_Group;*/
CALL CTS_DC_MatchMonitor_Rule_Get(1,50,@orr); select @orr; -- 111880559254
CALL CTS_DC_MatchMonitor_Rule_Process(1,111880559254,22081995,1,1);
CALL CTS_DC_MatchMonitor_Rule_Complete(1,111880559254,22081995,1,1,
...
CALL CTS_DC_MatchMonitor_Staging_Clean(1,111880559254);
...
CALL CTS_DC_MatchMonitor_Rule_Complete(1,111880559255,22081995,1,1,'[{"GroupID":1,"IsHedging":0,"TransIDList":"111880559253,111880559254,111880559255","CustIDList":"37144071,37144072,37144073","OldGroupIDList":"0,2"}]');
...
SELECT  * FROM CTS_DataCenter.Temp_Group;*/
CALL CTS_DC_MatchMonitor_Rule_Get(1,50,@orr); select @orr; -- 111880559256
CALL CTS_DC_MatchMonitor_Rule_Process(1,111880559256,22081995,1,1);
CALL CTS_DC_MatchMonitor_Rule_Complete(1,111880559256,22081995,1,1,'[{"GroupID":1,"IsHedging":1,"TransIDList":"111880559253,111880559254,111880559255,111880559256","CustIDList":"37144071,37144072,37144073,37144074","OldGroupIDList":"0,2"}]');
CALL CTS_DC_MatchMonitor_Staging_Clean(1,111880559256);
...
CALL CTS_DC_MatchMonitor_Rule_Complete(1,111880559260,22081995,1,1,'[
...
SELECT * FROM CTS_DataCenter.SystemParameter where ParameterID IN (20, 47);
SELECT * FROM CTS_DataCenter.MatchMonitorStagingLive where matchid = 22081995;
SELECT * FROM CTS_DataCenter.MatchMonitor where matchid = 22081995;
SELECT * FROM CTS_DataCenter.MatchMonitorDetails where matchid = 22081995;