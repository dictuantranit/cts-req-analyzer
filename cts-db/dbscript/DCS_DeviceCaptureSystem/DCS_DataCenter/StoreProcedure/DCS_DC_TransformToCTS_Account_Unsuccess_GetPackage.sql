...
DROP PROCEDURE IF EXISTS `DCS_DC_TransformToCTS_Account_Unsuccess_GetPackage`;

DELIMITER $$
CREATE DEFINER=`ctsOwner`@`%` PROCEDURE `DCS_DC_TransformToCTS_Account_Unsuccess_GetPackage`(IN ip_NoOfAccount INT)
...
BEGIN
	...
	Revisions:
        ...
        #4. [20200522@CaseyHuynh][133486]:  Add NOLOCK Command;
