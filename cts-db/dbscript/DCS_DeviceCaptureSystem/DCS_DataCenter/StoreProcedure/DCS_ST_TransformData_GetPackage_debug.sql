...
DROP PROCEDURE IF EXISTS DCS_DataCenter.DCS_ST_TransformData_GetPackage_Debug$$

CREATE DEFINER=`casey.vn`@`%` PROCEDURE DCS_DataCenter.DCS_ST_TransformData_GetPackage_Debug (IN ip_IsProcessed TINYINT, IN ip_NoOfTickets INT, IN ip_NoOfBatch INT)
BEGIN
	/*
