...
USE DCS_Extra;
CREATE TABLE `DCSExtraLog` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `LogName` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `InsertTime` datetime(4) DEFAULT NULL,
  `OtherText` text COLLATE utf8_unicode_ci,
  `JsonString1` json DEFAULT NULL,
  `JsonString2` json DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `IX_CTSLog_LogName` (`LogName`)
) ENGINE=InnoDB;

DROP PROCEDURE IF EXISTS `DCS_ET_T 144  ransform_Transaction_Insert`;
...
BEGIN
    /*
	    ...
	    Revisions:
            ...
            - 2023292023@Casey.Huynh: CTMAX, Velki, Remove insert into CTSCustomerLastLoginTimeProcess [RedmineID: #190118]
    ...
    */
    ...
    INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':1');
    
	INSERT INTO Temp_RawTransaction(TransID, LoginName, TransTime, SubscriberID, SubscriberType, DeviceCode , URLDetails, UserAgentKey, IP, IPID, ActionResultID, Flagged, PluginID, TransStatus, CreatedDate, FingerprintCode, BotDetectionValue, BotComponentID)
	SELECT  rt.TransID
	    ,   rt.LoginName
        ,   rt.TransTime
        ,   su.SubscriberID
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':2');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':3');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':4');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':5');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':6');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':7');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':8');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':9');
    
    INSERT IGNORE INTO  DCS_Extra.Transaction(RawTransID, LoginName, TransTime, SubscriberID, AccountID, URLID, UserAgentKey , IP, IPID, ActionResultID, Flagged, PluginID, TransStatus, CreatedDate, InsertTime, DeviceCode, FingerprintCode, BotDetectionValue, BotComponentID)
   	SELECT  trt.TransID
	    ,   trt.LoginName
        ,   trt.TransTime                
	    ,   trt.SubscriberID
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':10');
    #================================================================
    
	INSERT IGNORE INTO DCS_Extra.ProcessedTransaction( LoginName, SubscriberName, TransTime, CreatedDate, DeviceCode, FingerprintCode, UserAgent , IP, IPID, Flagged, PluginID, URL, Action, ActionResult, InvalidDevice, TransStatus, IsProcessed, TransID, InsertTime, BotDetectionValue, BotComponentID)
	SELECT  rt.LoginName
        ,   rt.SubscriberName
        ,   rt.TransTime
        ,   rt.CreatedDate
    ...
    INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':11');
	...
	INSERT INTO DCS_Extra.DCSExtraLog(LogName, InsertTime, OtherText)
	SELECT 'DCS_ET_Transform_Transaction_Insert', current_timestamp(3), CONCAT('ip_FromTransID',ip_FromTransID,',ip_ToTransID:',ip_ToTransID,':12');
END$$
DELIMITER ;
